# Disclaimer & Acceptable Use — sangse

`sangse` is part of the [gptaku-plugins](https://github.com/fivetaku/gptaku_plugins)
...
`sangse` is a general-purpose developer tool. Like most general-purpose tools, it
